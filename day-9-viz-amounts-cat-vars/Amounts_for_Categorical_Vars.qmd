...
#fct_infreq will reorder the categories/level by frequency of values, from least to greatest. Used when R is computing the frequencies automatically.
gss |> 
...
gss_religion |> 
  ...
  #fct_reorder is used (versus fct_infreq) when the variable is already summarized and you reorder by that value (in this case, proportion) 
