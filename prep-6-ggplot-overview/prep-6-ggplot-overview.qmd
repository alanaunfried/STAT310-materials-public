...
Add a setup chunk that loads the tidyverse packages. (Note Dr. U has already done this for you!)
...
#try adding ggsave and customizing the width and height
```
